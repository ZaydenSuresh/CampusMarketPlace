    ...
    process.env.SUPABASE_ANON_KEY,
    {
      cookies: {
        ...
        set: function(name, value, options) {
          ...
          console.log('[supabase.js] Setting cookie:', name, '->', serialized);
          ...
          console.log('[supabase.js][SAFE] Setting cookie:', name, '->', serialized);
          console.log('[supabase.js][SAFE] ALL Set-Cookie header(s):', myRes.getHeader && myRes.getHeader('Set-Cookie'));
        },
